	...
	************************************************************/
	...
	jQuery(".login-panel a").click(function(){
		...
		else
		{
			...
			/**Hide Join-panel**/
			jQuery(".join-panel a").removeClass("open");
			jQuery(".dropdown-join").fadeOut("fast");
    ...
    jQuery(".join-panel a").click(function(){
		if(jQuery(this).hasClass("open"))
		{
			jQuery(this).removeClass("open");
			jQuery(".dropdown-join").fadeOut("fast");
		...
		{
			jQuery(this).addClass("open");
			jQuery(".dropdown-join").fadeIn("fast");
			
			/**Hide login-panel**/
			jQuery(".login-panel a").removeClass("open");
			jQuery(".dropdown-login").fadeOut("fast")
			
			/* Hide search box when join panel open */
			jQuery('.search-box input[type="text"]').stop().fadeOut(100);
			jQuery('.search-box .icon').removeClass("open");
			jQuery(".search-box").css("border-right","solid 1px #ebebeb");
		}
	...
	jQuery('.dropdown-join').click(function(e) {
		e.stopPropagation();
	});
	...
	jQuery(".dropdown-join form input#password").blur(function(){
		if(jQuery(this).val()==""){jQuery(this).attr("type","text"); jQuery(this).val('Create password');}
	});
    
    jQuery(".dropdown-join form input#confirm-password").blur(function(){
		if(jQuery(this).val()==""){jQuery(this).attr("type","text"); jQuery(this).val('Confirm password');}
	});
    
	
	jQuery(".dropdown-join form input[type='text']").blur(function(){
		if(jQuery(this).val()==""){jQuery(this).val('Your email');}
	});
	...
	jQuery(".search-box .icon").click(function(){
		...
		else
		{
			...
			/* Hide Join panel when search box open */
			jQuery(".join-panel a").removeClass("open");
			jQuery(".dropdown-join").fadeOut("fast");
